            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarButtonsExample">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <% } else { %>
                        <a data-mdb-ripple-init class="btn btn-link px-3 me-2" href="/pages/login.jsp">Login</a>
                        <a data-mdb-ripple-init class="btn btn-primary me-3" href="/pages/register.jsp">Register for
                            free</a>
                            <% } %>
                    </div>
                </div>
