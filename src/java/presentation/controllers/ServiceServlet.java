...
import infrastructure.services.MailServices;
import infrastructure.services.OtpServices;
...
public class ServiceServlet extends HttpServlet {
    ...
    private void sendEmail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MailResponse mailResponse = MAIL_SERVICES.sendEmail(email, subject, body);
